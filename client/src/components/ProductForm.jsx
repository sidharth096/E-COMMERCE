...
const ProductFormModal = ({ onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!title || !subcategory || !description || variants.some(v => !v.ram || !v.price || !v.quantity) || images.length === 0) {
...
return (
    <Modal isOpen={isOpen} contentLabel="Add Product" style={modalStyle}>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <div className="w-2/3">
          {/* Use a dropdown to select the subcategory */}
          <select
            className="border rounded-md text-xs p-2 w-full"
            value={subcategory}
        ...
        {/* Assume you have a way to handle multiple image uploads */}
        <div className="mb-3 flex items-center">
        ...
        <div className="flex justify-end mt-4 text-xs">
          ...
          <button
            ...
            onClick={() => dispatch(closeModalProduct())}
          >
            DISCARD
          </button>
        </div>
